...
if(isset($_POST["boton_subir"])){
    ...
    if(is_uploaded_file($tmp) && $tamano <= 10000000){ 
        ...
        if (($tipo == "video/webm") || ($tipo == "image/gif")){
            ...
            if ( $tipo == "image/gif" ){
                echo '<img src="'.$urlnueva.'" /><br><br>';

                echo "<div class='row'>";
                echo "<div class='col s2 offset-s3'><p style='font-size:17px'><b>Image URL:</b></p></div>";
                echo "<div class='col s5'><textarea id='ta-gif-uno'>http://localhost/files/$titulo.$md5.$ext</textarea></div>";
                ...
                echo "<div class='col s5'><textarea id='ta-gif-dos'><img src='http://localhost/files/$titulo.$md5.$ext'></textarea></div>";
                ...
                echo "<div class='row'><video src='".$urlnueva."' type='video/webm' autoplay preload controls></div><br>";

                echo "<div class='row'>";
                echo "<div class='col s2 offset-s3'><p style='font-size:17px'><b>Video URL:</b></p></div>";
                echo "<div class='col s5'><textarea id='ta-webm-uno'>http://localhost/files/$titulo.$md5.$ext</textarea></div>";
                ...
                echo "<div class='col s5'>
                     <textarea id='ta-webm-dos'><video src='http://localhost/files/$titulo.$md5.$ext' type='video/webm' controls></textarea>
                     </div>"; 
